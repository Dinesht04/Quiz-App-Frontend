...
export default function SignInPage({
  ...
  return (
    <AuthPage SignInPage={<SignInFunction searchParams={searchParams} />} />
  );
}
...
function SignInFunction({
  ...
  return (
    <>
      <div className="flex flex-col space-y-4 gap-4 p-8 max-w-md mx-auto  shadow-lg rounded-lg mt-10">
