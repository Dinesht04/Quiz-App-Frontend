...
import { Play, Users, Trophy, Zap, Brain, Clock } from "lucide-react";
        ...
        <div className="flex justify-center items-center space-x-8 h-screen">
            <div className="space-y-8 text-center lg:text-left">
                    <div className="space-y-4">
                        ...
                        Join the ultimate real-time quiz experience. Create rooms, challenge friends, and test your knowledge together on <span className="text-amber-700">ANY TOPIC</span> you want!
                        </p>
                    </div>
                ...
                <div id="roomCard" className="">
                    ...
                    <JoinRoomCard username={session.user.name} SignOut={<SignOut/>} expires={session.expires} />
                    {/* <ConnectionStatus/> */}
                </div>
