                    ...
                    {isConnected ? (
                      ...
                      <>
                        <div className="flex items-center space-x-2 px-4 py-2  rounded-full ">
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-red-500/20 text-red-300 border-red-500/30 text-sm"
                          >
                            Disconnected
                          </Badge>
                        </div>
                      ...
                      isHost ? (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="px-4 py-4 bg-gray-800/30 rounded-2xl border border-gray-700/50">
                              ...
                              <div className="flex justify-center text-lg text-gray-300 mt-3">
                                {difficulty > 0 && (
                                  <span
                                    className={`font-bold ${difficultyColors[difficulty - 1]}`}
                                  >
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-gray-300 text-lg">
                            The Host is choosing the Topic and Difficulty,
