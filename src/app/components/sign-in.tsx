                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      {isLoading ? (
                        <div className="flex items-center">
                          <div className="w-5 h-5 border-2 border-gray-400 border-t-black rounded-full animate-spin mr-3" />
                          Connecting...
                        </div>
                      ) : (
                        <>
                    ...
                    >
                      {guestLoading ? (
                        <div className="flex items-center">
                          <div className="w-5 h-5 border-2 border-[#A9F99E] border-t-transparent rounded-full animate-spin mr-3" />
                          Setting up...
                        </div>
                      ) : (
                        <>
