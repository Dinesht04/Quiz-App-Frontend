...
export default function TrendingTopics(){
  ...
  const popularTopics = [
    { name: "Space Exploration", count: "2.4k", trend: "+12%", color: "from-purple-500 to-pink-500", icon: Rocket },
    { name: "Ancient History", count: "1.8k", trend: "+8%", color: "from-amber-500 to-orange-500", icon: Crown },
    { name: "Modern Science", count: "1.5k", trend: "+15%", color: "from-cyan-500 to-blue-500", icon: Brain },
    { name: "Pop Culture", count: "1.2k", trend: "+5%", color: "from-green-500 to-emerald-500", icon: Star },
  ]
  return(
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-white text-sm font-semibold">{topic.name}</p>
                          <p className="text-gray-400 text-xs">{topic.count} active battles</p>
                        </div>
                      </div>
                      <Badge
                        variant="outline"
