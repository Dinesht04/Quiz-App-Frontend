          ...
          <CardContent className="space-y-8 px-8 pb-8">
            <div className="text-center space-y-4">
              <p className="text-gray-600">
                Create rooms, challenge friends, and test your knowledge together on any topic you want!
              </p>
            ...
            <div
              className="h-14 flex justify-center items-center text-white rounded-full transform hover:scale-105 transition-all duration-300 font-semibold text-lg"
            >
