...
[
  ...
  },
  {
    ...
    options: ['console.log()', 'document.write()', 'window.alert()', 'print()'],
...
export default function Quiz() {
  ...
  if (currentQuestion === 'over') {
    return (
      <div>
        QUiz Over Personal SCore - {score}
        Overall SCore when quiz ended is console.logged. Have yet to track the
        state and display it propoerly
      </div>
    );
  }
